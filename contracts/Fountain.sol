...
contract Fountain is Ownable {
    ...
    uint64 public gulpRewardChangeBlocks = 170000;
    ...
    constructor(
        ...
        address _devaddr,
        uint256 _startBlock,
        uint64 _gulpRewardChangeBlocks,
        uint256[50] memory _gulpPerBlock

    ) public {
        gulp = _gulp;
        devaddr = _devaddr;
        startBlock = _startBlock;
        gulpRewardChangeBlocks = _gulpRewardChangeBlocks;
        gulpPerBlock = _gulpPerBlock;
